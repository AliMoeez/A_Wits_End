...
enemy_1_level_3_x=[1100,1150,1200,1800,1900,2700,2900,3000,3100,3400,3500,3700]
...
enemy_two_level_4_x_2=[800,900,1100,1300,1500,2500,2700,2900] ; enemy_two_level_4_y_2=[350,350,350,350,350,350,350,350]
...
for idx,number in enumerate(enemy_two_level_4_x_2):
    enemy_two_level_4_rect_2.append(pygame.Rect(enemy_two_level_4_x_2[idx],enemy_two_level_4_y_2[idx],45,55))
...
main_boss_attack_2=[main_boss_attack_2_1,main_boss_attack_2_2,main_boss_attack_2_3,main_boss_attack_2_5,main_boss_attack_2_6]
main_boss_attack_2_flip=[main_boss_attack_2_flip_1,main_boss_attack_2_flip_2,main_boss_attack_2_flip_3,main_boss_attack_2_flip_5,main_boss_attack_2_flip_6]
...
ally_1_run_1=pygame.image.load(r"A_Wit's_End\Allies_1\Sprites\Heavy Bandit\Run\HeavyBandit_Run_0.png") ; ally_1_run_2=pygame.image.load(r"A_Wit's_End\Allies_1\Sprites\Heavy Bandit\Run\HeavyBandit_Run_1.png") ; ally_1_run_3=pygame.image.load(r"A_Wit's_End\Allies_1\Sprites\Heavy Bandit\Run\HeavyBandit_Run_2.png")
ally_1_run_4=pygame.image.load(r"A_Wit's_End\Allies_1\Sprites\Heavy Bandit\Run\HeavyBandit_Run_3.png") ; ally_1_run_5=pygame.image.load(r"A_Wit's_End\Allies_1\Sprites\Heavy Bandit\Run\HeavyBandit_Run_4.png") ; ally_1_run_6=pygame.image.load(r"A_Wit's_End\Allies_1\Sprites\Heavy Bandit\Run\HeavyBandit_Run_5.png") ; ally_1_run_7=pygame.image.load(r"A_Wit's_End\Allies_1\Sprites\Heavy Bandit\Run\HeavyBandit_Run_6.png") ; ally_1_run_8=pygame.image.load(r"A_Wit's_End\Allies_1\Sprites\Heavy Bandit\Run\HeavyBandit_Run_7.png")
ally_1_run_1=pygame.transform.scale(ally_1_run_1,(75,85)) ; ally_1_run_2=pygame.transform.scale(ally_1_run_2,(75,85)) ; ally_1_run_3=pygame.transform.scale(ally_1_run_3,(75,85)) ; ally_1_run_4=pygame.transform.scale(ally_1_run_4,(75,85)) ; ally_1_run_5=pygame.transform.scale(ally_1_run_5,(75,85)) ; ally_1_run_6=pygame.transform.scale(ally_1_run_6,(75,85)) ; ally_1_run_7=pygame.transform.scale(ally_1_run_7,(75,85)) ; ally_1_run_8=pygame.transform.scale(ally_1_run_8,(75,85))
ally_1_run_flip_1=pygame.transform.flip(ally_1_run_1,True,False) ; ally_1_run_flip_2=pygame.transform.flip(ally_1_run_2,True,False) ; ally_1_run_flip_3=pygame.transform.flip(ally_1_run_3,True,False) ; ally_1_run_flip_4=pygame.transform.flip(ally_1_run_4,True,False) ; ally_1_run_flip_5=pygame.transform.flip(ally_1_run_5,True,False) ; ally_1_run_flip_6=pygame.transform.flip(ally_1_run_6,True,False) ; ally_1_run_flip_7=pygame.transform.flip(ally_1_run_7,True,False) ; ally_1_run_flip_8=pygame.transform.flip(ally_1_run_8,True,False)
ally_1_icon=pygame.image.load(r"A_Wit's_End\Allies_1\Sprites\Heavy Bandit\Icon\HeavyBandit_Icon.png") ; ally_1_icon=pygame.transform.scale(ally_1_icon,(120,120))
...
ally_1_level_3_part_1_x_idle=[1710,3795,3910] ; ally_1_level_3_part_1_y_idle=[570,570,570]
ally_1_level_3_part_1_x_run=[3200,4300] ; ally_1_level_3_part_1_y_run=[570,570]
ally_1_level_3_part_2_x_idle=[400,1500,2050,2700,3100] ; ally_1_level_3_part_2_y_idle=[570,570,570,570,570]
ally_1_level_3_part_2_x_run=[800,1200,1700,2100,2200] ; ally_1_level_3_part_2_y_run=[570,570,570,570,570]
...
class Menu:
    ...
    def level_selection(self):
        ...
        if level_screen:
            ...
            rectangle_level_2_bg=pygame.draw.rect(SCREEN,(176,196,222),pygame.Rect(SCREEN_WIDTH//2-100,SCREEN_HEIGHT//2-50,60,90))
            rectangle_level_2=pygame.draw.rect(SCREEN,(120,159,179),pygame.Rect(SCREEN_WIDTH//2-100,SCREEN_HEIGHT//2-50,60,90),width=10)
            font_game=pygame.font.SysFont("Impact",28)  ; show_font_knight=font_game.render("2",1,(120,159,179)) ; SCREEN.blit(show_font_knight,(SCREEN_WIDTH//2-75,SCREEN_HEIGHT//2-25)) 
            rectangle_level_3_bg=pygame.draw.rect(SCREEN,(176,196,222),pygame.Rect(SCREEN_WIDTH//2+100,SCREEN_HEIGHT//2-50,60,90))
            rectangle_level_3=pygame.draw.rect(SCREEN,(120,159,179),pygame.Rect(SCREEN_WIDTH//2+100,SCREEN_HEIGHT//2-50,60,90),width=10) 
            font_game=pygame.font.SysFont("Impact",28)  ; show_font_knight=font_game.render("3",1,(120,159,179)) ; SCREEN.blit(show_font_knight,(SCREEN_WIDTH//2+125,SCREEN_HEIGHT//2-25))   
            rectangle_level_4_bg=pygame.draw.rect(SCREEN,(176,196,222),pygame.Rect(SCREEN_WIDTH//2+300,SCREEN_HEIGHT//2-50,60,90))
            rectangle_level_4=pygame.draw.rect(SCREEN,(120,159,179),pygame.Rect(SCREEN_WIDTH//2+300,SCREEN_HEIGHT//2-50,60,90),width=10)
            font_game=pygame.font.SysFont("Impact",28)  ; show_font_knight=font_game.render("4",1,(120,159,179)) ; SCREEN.blit(show_font_knight,(SCREEN_WIDTH//2+325,SCREEN_HEIGHT//2-25))        
            ...
            if pygame.Rect.collidepoint(rectangle_level_4,pygame.mouse.get_pos()) and event.type==pygame.MOUSEBUTTONDOWN:
                ...
                self.player_rect.x=20 ; self.player_rect.y=310
        if level_1:
            level_screen=False
            if key[pygame.K_r]:
...
class Game:
    ...
    def level_four(self):
        ...
        if level_4_part_2:
            ...
            if self.player_rect.x>=3050: 
                self.camera_x_y[0]=3050-210 
                if self.player_rect.x>3885: self.player_rect.x=3885
    ...
    def level_four_dialogue(self):
        ...
        self.player_boss_dialogue=[
            ...
            ("........ So be it, you scum. Ill throw you a bone and make this fight fair. Take this...","Kornos",self.main_boss_icon),
            ("Augh!!!","You",self.player_icon),
        ...
        if level_4_begin_dialogue and not level_4_dialogue_1_once or level_4_player_boss_dialogue and not level_4_dialogue_2_once or player_lose_level_4_dialogue and not level_4_dialogue_3_once or player_win_level_4_dialogue and not level_4_dialogue_4_once:
            ...
            if event.type==pygame.MOUSEBUTTONUP and change_dialogue_cond_1:
                change_dialogue_cond_1=False ; change_dialogue=True  
            if change_dialogue:
                if self.level_4_dialogue_length[0]==2:
                    self.player_current_health[0]=1000
...
class Player(Game):
        ...
        if (level_1 or level_2 or level_3 or level_3_part_2 or level_3_part_3 or level_4 or level_4_part_2) and not player_death:
            ...
            if jump and jump_condition and not attack and not dialogue_move_condition:
                ...
                if self.player_jump_length[0]>=-17:
                    self.player_y_movement[0]=-7.50 #+=-7.50
                    self.player_jump_length[0]-=1 #1
                else: 
                ...
                self.player_jump_number[0]+=0.85 #0.85
    ...
    def attack(self,player_attack_type_1,player_attack_type_1_flip,player_attack_type_2,player_attack_type_2_flip,
        ...
        if (level_1 or level_2_part_2 or level_3 or level_3_part_2 or level_3_part_3 or level_4 or level_4_part_2) and not player_death and not dialogue_move_condition:
            if key[pygame.K_e]:
...
class EnemyOne(Player):
                ...
                for idx,knight in enumerate(enemy_1_rect):
                    if self.enemy_1_distance_list[idx]<50:
                        if player_idle_right and self.player_rect.x<=enemy_1_rect[idx].x:
                            self.enemy_1_health_list[idx]-=40 #25
                        if player_idle_left and self.player_rect.x>enemy_1_rect[idx].x:
                            self.enemy_1_health_list[idx]-=40
                        attack_done=False
    ...
    def fall(self):
        ...
        if (level_1 or level_2_part_2 or level_3_part_3) and not reset_enemy_position:
            if level_1: 
                enemy_1_rect=self.enemy_level_1_rect ; self.cam_y_1=10 ; self.cam_y_2=45
            if level_2_part_2 : 
                enemy_1_rect=self.enemy_1_level_2_rect ; self.cam_y_1=10 ; self.cam_y_2=45
            if level_3_part_3 : 
                enemy_1_rect=self.enemy_1_level_3_rect ; self.cam_y_1=25 ; self.cam_y_2=60
            for idx,knight in enumerate(enemy_1_rect):
                if self.enemy_1_health_list[idx]<=0:
                    self.enemy_1_x_movement[idx]=0
...
class EnemyTwo(Player):
    ...
    def movement(self):
        ...
        if level_1 or level_4 or level_4_part_2:
            ...
            for idx,enemy_knight in enumerate(enemy_rect):
                ...
                if self.enemy_two_x_movement[idx]>0: self.enemy_two_fall_direction_set[idx]=1
                if self.enemy_two_x_movement[idx]<0: self.enemy_two_fall_direction_set[idx]=2
                    
                if len(self.enemy_two_distance_list)>len(enemy_rect):
                    del self.enemy_two_x_movement[-1] ; del self.enemy_two_distance_list[0] ; del self.enemy_two_health[-1]
                    del self.enemy_two_fall_number[-1] ; del self.enemy_two_fall_direction_set[-1]  ; del self.enemy_two_idle_number[-1]
        if level_1: 
            if not level_1_enemy_fight_condition:
                for idx,enemy_knight in enumerate(self.enemy_two_level_1_rect):
                    ...
                    if self.enemy_two_idle_number[0]>4: self.enemy_two_idle_number[0]=0
            if level_1_enemy_fight_condition:
                for idx,enemy_knight in enumerate(self.enemy_two_level_1_rect):
                    ...
                    if self.enemy_two_run_number[0]>10: self.enemy_two_run_number[0]=0
        ...
        if level_4 or level_4_part_2:
                ...
                for idx,enemy_knight in enumerate(enemy_rect):
                    ...
                    if (self.enemy_two_distance_list[idx]>700 or self.player_rect.y-enemy_knight.y>12) and self.enemy_two_health[idx]>0:
                        ...
                        if self.enemy_two_idle_number[idx]>4: self.enemy_two_idle_number[idx]=0
    ...
    def attack(self):
        ...
        if level_1 and level_1_enemy_fight_condition or level_4 or level_4_part_2:
            if level_1: 
            ...
            for idx,enemy_knight in enumerate(enemy_rect):
                ...
                if self.enemy_two_health[idx]>0:
                    if (level_1 or level_4 or level_4_part_2) and self.enemy_two_distance_list[idx]<=30:
                        self.enemy_two_x_movement[idx]=0
                        if self.enemy_two_attack_type[0]>2:
                            self.enemy_two_attack_type[0]=1
                        if self.enemy_two_attack_type[0]==1:
                            if self.player_rect.x>=enemy_knight.x:
                                SCREEN.blit(self.enemy_two_attack_1[int(self.enemy_two_attack_number[idx]//2)],(enemy_knight.x-self.camera_x_y[0]-self.x_1_offset,enemy_knight.y-self.camera_x_y[1]-self.y_offset))
                            if self.player_rect.x<enemy_knight.x:
                        ...
                        if self.enemy_two_attack_type[0]==2:
                            if self.player_rect.x>=enemy_knight.x:
                                SCREEN.blit(self.enemy_two_attack_2[int(self.enemy_two_attack_number[idx]//2)],(enemy_knight.x-self.camera_x_y[0]-self.x_1_offset,enemy_knight.y-self.camera_x_y[1]-self.y_offset))
                            if self.player_rect.x<enemy_knight.x:
    ...
    def reset_position(self):
        ...
        self.enemy_two_level_4_x_1=enemy_two_level_4_x_1 ; self.enemy_two_level_4_y_1=enemy_two_level_4_y_1
        self.enemy_two_level_4_x_2=enemy_two_level_4_x_2 ; self.enemy_two_level_4_y_2=enemy_two_level_4_y_2
        if (level_1 and reset_enemy_position) or (level_4 and reset_enemy_position) or (level_4_part_2 and reset_enemy_position):
            if level_1: 
            ...
            self.enemy_two_health.clear()
            for idx,knight in enumerate(knight_rect):
                knight_rect[idx].x=knight_x[idx]
                
    def collision_with_object(self,tile_level_1,level_4_tile_set_rect,level_4_tile_set_part_2_rect):
        global level_4,level_4_part_2
        if level_1:
        ...
        if level_4_part_2:
            tile_level= self.level_4_tile_set_part_2_rect ; enemy_rect=self.enemy_two_level_4_rect_2
        if level_1 or level_4 or level_4_part_2:
            hit_tile=[]
            for idx,enemy_knight in enumerate(enemy_rect):
                for tiles in tile_level:
    ...
    def collision_with_object_logic(self,tile_level_1,level_4_tile_set_rect,level_4_tile_set_part_2_rect):
        ...
        if level_1 or level_4 or level_4_part_2:
            ...
            collision=EnemyTwo.collision_with_object(self,tile_level_1,level_4_tile_set_rect,level_4_tile_set_part_2_rect)
            for tile in collision:
                for idx,enemy_knight in enumerate(enemy_rect):
...
class MainBoss(Player):
    ...
    def idle(self):
        ...
        self.main_boss_idle=main_boss_idle ; self.main_boss_idle_flip=main_boss_idle_flip ; self.main_boss_idle_number=main_boss_idle_number ; self.main_boss_health=main_boss_health
        if level_1:
        ...
        if level_4_part_2:
            if level_4_player_boss_dialogue and not level_4_dialogue_2_once and self.main_boss_health[0]>0 or self.player_current_health[0]<=0:
                if self.player_rect.x<self.main_boss_rect_level_1.x:
    ...
    def movement(self):
        ...
        self.main_boss_run_number=main_boss_run_number; self.main_boss_level_1_x=main_boss_level_1_x ; self.enemy_two_health=enemy_two_health ; self.main_boss_level_1_y=main_boss_level_1_y ; self.main_boss_health=main_boss_health
        if level_1:
            self.main_boss_y_movement[0]=8
        ...
        if level_4_part_2 and all(idx<=0 for idx in self.enemy_two_health) and self.main_boss_health[0]>0 and self.player_current_health[0]>0:
            ...
            if not level_4_player_boss_dialogue and not level_4_dialogue_2_once:
                ...
                if self.player_rect.x<self.main_boss_rect_level_4_part_2.x:
                    ...
                    self.main_boss_x_movement[0]=-4
                self.main_boss_run_number[0]+=0.55
            ...
            if level_4_dialogue_2_once:
                self.player_boss_distance=math.sqrt(math.pow(self.player_rect.x-self.main_boss_rect_level_4_part_2.x,2)+math.pow(self.player_rect.y-self.main_boss_rect_level_4_part_2.y,2))
                if self.player_boss_distance>100:
                    if self.player_rect.x>=self.main_boss_rect_level_4_part_2.x:
                        SCREEN.blit(self.main_boss_run[int(self.main_boss_run_number[0])//2],(self.main_boss_rect_level_4_part_2.x-self.camera_x_y[0],self.main_boss_rect_level_4_part_2.y-self.camera_x_y[1]+20))
                        self.main_boss_x_movement[0]=4
                    if self.player_rect.x<self.main_boss_rect_level_4_part_2.x:
    ...
    def attack(self):
        self.main_boss_attack_1=main_boss_attack_1 ; self.main_boss_attack_1_flip=main_boss_attack_1_flip ; self.main_boss_attack_2=main_boss_attack_2 ; self.main_boss_attack_2_flip=main_boss_attack_2_flip
        self.main_boss_attack_number=main_boss_attack_number ; self.main_boss_attack_type=main_boss_attack_type ; self.player_current_health=player_current_health ; self.main_boss_health=main_boss_health
        if level_4_part_2 and level_4_dialogue_2_once and self.main_boss_health[0]>0 and self.player_current_health[0]>0:
            if self.player_boss_distance<100:
                self.main_boss_x_movement[0]=0
                self.main_boss_attack_type.append(random.randint(1,2))
                if len(self.main_boss_attack_type)>1: del self.main_boss_attack_type[-1]
                if self.main_boss_attack_type[0]==1: 
                    self.attack_type=self.main_boss_attack_1 ; self.attack_type_flip=main_boss_attack_1_flip
                if self.main_boss_attack_type[0]==2: 
                    self.attack_type=self.main_boss_attack_2 ; self.attack_type_flip=main_boss_attack_2_flip
                if self.player_rect.x>=self.main_boss_rect_level_4_part_2.x:
                    SCREEN.blit(self.attack_type[int(self.main_boss_attack_number[0])//2],(self.main_boss_rect_level_4_part_2.x-self.camera_x_y[0],self.main_boss_rect_level_4_part_2.y-self.camera_x_y[1]+20))
                if self.player_rect.x<self.main_boss_rect_level_4_part_2.x:
                    SCREEN.blit(self.attack_type_flip[int(self.main_boss_attack_number[0])//2],(self.main_boss_rect_level_4_part_2.x-self.camera_x_y[0],self.main_boss_rect_level_4_part_2.y-self.camera_x_y[1]+20))
                self.main_boss_attack_number[0]+=0.50
    ...
    def dash(self):
        ...
        if level_4_part_2 and level_4_dialogue_2_once and self.main_boss_health[0]>0 and self.player_current_health[0]>0:
            if self.player_boss_distance<500:
                self.main_boss_dash_number[0]+=1
                self.main_boss_dash_frequency.append(random.randint(55,70))
                if len(self.main_boss_dash_frequency)>1: del self.main_boss_dash_frequency[-1]
                if self.main_boss_dash_number[0]>self.main_boss_dash_frequency[0]:
    ...
    def fall(self):
        ...
        self.main_boss_fall=main_boss_fall ; self.main_boss_fall_flip=main_boss_fall_flip ; self.main_boss_fall_number=main_boss_fall_number
        if level_4_part_2 and self.main_boss_health[0]<=0:
            self.main_boss_x_movement[0]=0
            if self.player_rect.x<=self.main_boss_rect_level_4_part_2.x and not fall_type_left or fall_type_right: fall_type_left=True
            if self.player_rect.x>self.main_boss_rect_level_4_part_2.x and not fall_type_left or fall_type_right: fall_type_right=True
            if fall_type_right:
                fall_type_left=False ; SCREEN.blit(self.main_boss_fall[int(self.main_boss_fall_number[0])//2],(self.main_boss_rect_level_4_part_2.x-self.camera_x_y[0],self.main_boss_rect_level_4_part_2.y-self.camera_x_y[1]+20))
            if fall_type_left:
                fall_type_right=False ; SCREEN.blit(self.main_boss_fall_flip[int(self.main_boss_fall_number[0])//2],(self.main_boss_rect_level_4_part_2.x-self.camera_x_y[0],self.main_boss_rect_level_4_part_2.y-self.camera_x_y[1]+20))
            self.main_boss_fall_number[0]+=0.45
            if self.main_boss_fall_number[0]>7:self.main_boss_fall_number[0]=7

    def reset_position(self):
        global reset_enemy_position,level_1_enemy_fight_condition
        self.main_boss_level_1_x=main_boss_level_1_x ; self.main_boss_level_1_y=main_boss_level_1_y
        self.main_boss_level_4_x=main_boss_level_4_x ; self.main_boss_level_4_y=main_boss_level_4_y
        if level_1 and reset_enemy_position:
            self.main_boss_rect_level_1.x=self.main_boss_level_1_x[0]
            self.main_boss_rect_level_1.y=250
            reset_enemy_position=False
        if level_4_part_2 and reset_enemy_position:   
            self.main_boss_rect_level_4_part_2.x=self.main_boss_level_4_x[0]
            self.main_boss_rect_level_4_part_2.y=self.main_boss_level_4_y[0]
            reset_enemy_position=False
        ...
        if level_3_part_2 and (level_3_dialogue_part_7_once or level_3_dialogue_part_8_once) and self.player_boss_two_distance<50 and self.boss_2_level_3_health[0]>0:
            ...
            if self.boss_2_attack_number[0]>9:
                ...
                if not enemy_stage_two:
                    self.player_current_health[0]-=50   #50
                if enemy_stage_two:
                    self.player_current_health[0]-=150  #150
        ...
        if level_3_part_2 and (level_3_dialogue_part_7_once or level_3_dialogue_part_8_once) and self.boss_2_level_3_health[0]>0:
            ...
            if attack:
                if player_idle_right and self.player_rect.x<=self.boss_2_level_3_rect.x and self.player_boss_two_distance<75:
                    self.boss_2_level_3_health[0]-=15 #50
...
while run:
    ...
    enemy_two=EnemyTwo(enemy_two_level_1_rect,enemy_two_x_movement,enemy_two_y_movement,enemy_two_rect_list,enemy_two_distance_list,enemy_two_health,enemy_two_level_4_rect_1,enemy_two_level_4_rect_2)
    enemy_two.movement()
    enemy_two.attack()
    enemy_two.player_hit()
    enemy_two.fall()
    enemy_two.reset_position()
    enemy_two.collision_with_object(tile_level_1,level_4_tile_set_rect,level_4_tile_set_part_2_rect)
    enemy_two.collision_with_object_logic(tile_level_1,level_4_tile_set_rect,level_4_tile_set_part_2_rect)
